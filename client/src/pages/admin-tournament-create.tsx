...
export default function AdminTournamentCreate() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      name: "Улаанбаатар Open 2025",
      description: "Тэмцээний товч тайлбар оруулна уу...",
      richDescription: "",
      startDate: "",
      endDate: "",
      registrationDeadline: "",
      location: "Ширээний теннисний төв",
      organizer: "МШТХ",
      maxParticipants: 32,
      entryFee: 0,
      participationTypes: ["singles", "doubles", "mixed_doubles", "team"],
      rules: "Тэмцээний дүрэм журам...",
      prizes: "Шагнал урамшуулалын мэдээлэл...",
      contactInfo: "Утас, и-мэйл...",
      schedule: "Тэмцээний хуваарь...",
      requirements: "Оролцоход тавигдах шаардлагууд...",
      backgroundImageUrl: "https://example.com/background.jpg",
      regulationDocumentUrl: "https://example.com/regulations.pdf",
      minRating: "Хязгаарлалтгүй",
      maxRating: "Хязгаарлалтгүй",
      isPublished: true,
    }
  });
