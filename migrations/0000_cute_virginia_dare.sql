...
CREATE TYPE "public"."player_rank" AS ENUM('Шинэ тоглогч', '3-р зэрэг', '2-р зэрэг', '1-р зэрэг', 'дэд мастер', 'спортын мастер', 'олон улсын хэмжээний мастер');--> statement-breakpoint
...
CREATE TABLE "clubs" (
	...
	"email" varchar,
	"logo_url" varchar,
	"color_theme" varchar DEFAULT '#22C55E',
	"created_at" timestamp DEFAULT now()
);
--> statement-breakpoint
